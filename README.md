...
| Programming Languages | Databases | Machine Learning & Data Science | Visualization & Dashboards | Tools & Others |
|-----------------------|-----------|--------------------------------|----------------------------|---------------|
